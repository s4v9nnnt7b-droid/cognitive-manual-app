...
- When the same failed episode explicitly describes both selecting among multiple materials or options and doing setup work before starting, emit choice_overload, preparation_load, and compound together. Do not omit either directly stated component.
